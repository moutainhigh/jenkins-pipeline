...
/**
 * 企业征信_未结清保理Service
 * @Class Name CreditUnclearedFactoringService
 * @author zhanghu
 * @Create In 2016年1月29日
 */
@Service
public class CreditUnclearedFactoringService extends  CoreManager<CreditUnclearedFactoringDao,CreditUnclearedFactoring> {
	...
	public int insertCreditUnclearedFactoring(CreditUnclearedFactoring record) {
		// 初始化默认数据
		record.preInsert();
		return this.dao.insertCreditUnclearedFactoring(record);
	}
