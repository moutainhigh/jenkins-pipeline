...
@XmlRootElement(name = "Channelconfig_ruleResponse")
public class ChannelconfigRuleResponse {

    @XmlElement(name = "DecisionID", namespace = "http://www.ibm.com/rules/decisionservice/Channelconfig_ruleapp/Channelconfig_rule", required = true)
