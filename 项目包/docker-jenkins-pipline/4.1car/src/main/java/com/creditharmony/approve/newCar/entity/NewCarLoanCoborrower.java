...
public class NewCarLoanCoborrower implements Serializable{
    ...
    private List<NewCustomerContactPerson> bContactPersons;
	...
	public List<NewCustomerContactPerson> getbContactPersons() {
		return bContactPersons;
	}

	public void setbContactPersons(List<NewCustomerContactPerson> bContactPersons) {
