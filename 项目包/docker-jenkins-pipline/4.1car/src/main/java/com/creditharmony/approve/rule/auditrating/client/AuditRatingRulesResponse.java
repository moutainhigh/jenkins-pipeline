...
@XmlRootElement(name = "AuditRating_rulesResponse")
public class AuditRatingRulesResponse {

    @XmlElement(name = "DecisionID", namespace = "http://www.ibm.com/rules/decisionservice/AuditRating_ruleapp/AuditRating_rules", required = true)
