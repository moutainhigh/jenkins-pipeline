...
import com.creditharmony.approve.newCar.dao.NewFileDiskInfoDao;
...
public class NewCarImageImpl implements NewCarImageService {
	...
	@Autowired
	private NewFileDiskInfoDao fileDiskInfoDao;
	...
	public String getImageUrl(String stepName, String loanCode,String contractVersion) {
		...
		NewFileDiskInfo fileDeiskInfo = fileDiskInfoDao.getByParam(queryParam);
