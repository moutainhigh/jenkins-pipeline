...
public class CarLoanInfo extends DataEntity<CarLoanInfo> {
	...
	// 车借_面审信息
	private ApplicationInterviewInfo applicationInterviewInfo;
	// 进件时间
	...
	public ApplicationInterviewInfo getApplicationInterviewInfo() {
		return applicationInterviewInfo;
	}

	public void setApplicationInterviewInfo(
			ApplicationInterviewInfo applicationInterviewInfo) {
