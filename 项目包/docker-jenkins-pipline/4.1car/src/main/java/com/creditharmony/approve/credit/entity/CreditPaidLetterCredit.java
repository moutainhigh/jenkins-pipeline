...
public class CreditPaidLetterCredit {
    private String id;
    ...
    private BigDecimal openLetterAmount;
    ...
    public BigDecimal getOpenLetterAmount() {
        return openLetterAmount;
    }

    public void setOpenLetterAmount(BigDecimal openLetterAmount) {
        this.openLetterAmount = openLetterAmount;
    }
